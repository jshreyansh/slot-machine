...
import {View, Text, StyleSheet, Animated, Easing, Button, TouchableOpacity, Alert} from 'react-native';
...
export default class SlotMachine extends Component {
    ...
    handleRefresh = () =>{
        // this.props.text = Math.floor(Math.random()*10000);
        console.log(this.state.text, "hello", this.props.text)
        this.setState({initialAnimation: true, text:Math.floor(Math.random()*10000)})
        console.log(this.state.text, "hello 222", this.props.text)
    ...
    spinTo(value) {
        this.text = value;
        const values = this.state.text;
        // this.getInitialSlotsValues(this.props);
    ...
    render() {
        ...
        return (<View style={[styles.container, this.props.styles.container]}>
            
                {slots}

                <Button onPress={this.handleRefresh} title="Refresh" />
